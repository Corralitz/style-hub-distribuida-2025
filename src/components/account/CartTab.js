...
import { sendCheckoutToQueue } from "../../services/checkout";

const CartTab = ({ cart, user }) => {
  ...
  const handleCheckout = async () => {
    try {
      ...
      // Send to queue
      const result = await sendCheckoutToQueue(checkoutData);
              ...
              >
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    onClick={() =>
                      cart.removeFromCart(item.id, item.size, item.color)
                    }
                  >
                    <X size={20} />
                  </button>
          ...
          <div className="p-6 bg-gray-50 border-t border-gray-200">
            ...
            <div className="flex space-x-4">
              <button
                ...
                disabled={processing}
                className="flex-1 bg-indigo-600 text-white py-3 px-6 rounded-lg hover:bg-indigo-700 font-medium disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center"
              >
                {processing ? (
                  <>
